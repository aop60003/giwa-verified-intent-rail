...
- public hosting remains blocked until protected CI, protected artifact metadata, external hosting approval, managed infrastructure approval, partner signoff, release owner approval, and rollback owner approval are recorded
